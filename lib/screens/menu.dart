...
import 'package:her_needs/widgets/left_drawer.dart';
import 'package:her_needs/screens/productentry_form.dart';
import 'package:her_needs/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
  MyHomePage({super.key});
  final String npm = '2306245541'; // NPM
  final String name = 'Lisa Margaretha Esron Tobing'; // Nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "herNeeds" dengan teks putih dan tebal.
        title: const Text(
          'herNeeds',
          style: TextStyle(
            color: Colors.white,
